namespace ProtocolTests.Protocol.HTTP.Session.Connection.Request.CheckPidAttribute
{
    ...
    using Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.HTTP.Session.Connection.Request.CheckPidAttribute;
    ...
    public class ErrorMessages
    {
        ...
        public void HTTP_CheckPidAttribute_EmptyAttribute()
        {
            ...
            string description = "Empty attribute 'Request@pid' in HTTP Session '0'. Connection ID '11'.";
        ...
        public void HTTP_CheckPidAttribute_InvalidAttribute()
        {
            ...
            string description = "Invalid value '0' in attribute 'Request@pid'. HTTP Session ID '1'. Connection ID '11'.";
        ...
        public void HTTP_CheckPidAttribute_NonExistingId()
        {
            ...
            string description = "Attribute 'Request@pid' references a non-existing 'Param' with ID '0'. HTTP Session ID '1'. Connection ID '11'.";
