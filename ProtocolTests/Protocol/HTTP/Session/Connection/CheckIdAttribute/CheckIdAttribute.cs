namespace SLDisValidatorUnitTests.Protocol.HTTP.Session.Connection.CheckIdAttribute
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.HTTP.Session.Connection.CheckIdAttribute;
