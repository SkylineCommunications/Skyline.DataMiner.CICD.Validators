namespace SLDisValidatorUnitTests.Protocol.HTTP.Session.Connection.Response.Content.CheckPidAttribute
{
    ...
    using SLDisValidator2.Tests.Protocol.HTTP.Session.Connection.Response.Content.CheckPidAttribute;
