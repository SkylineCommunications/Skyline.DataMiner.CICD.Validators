namespace SLDisValidatorUnitTests.Protocol.QActions.QAction.CSharpSLProtocolSetRow
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.QActions.QAction.CSharpSLProtocolSetRow;
