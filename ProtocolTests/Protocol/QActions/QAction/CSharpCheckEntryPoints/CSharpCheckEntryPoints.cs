namespace SLDisValidatorUnitTests.Protocol.QActions.QAction.CSharpCheckEntryPoints
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.QActions.QAction.CSharpCheckEntryPoints;
