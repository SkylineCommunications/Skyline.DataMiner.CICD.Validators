namespace ProtocolTests.Protocol.Triggers.Trigger.CheckIdAttribute
{
    using System;
    ...
    using Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.Triggers.Trigger.CheckIdAttribute;
    ...
    public class Validate
    {
        ...
        [TestMethod]
        public void Trigger_CheckIdAttribute_DuplicatedId()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
    ...
    public class Attribute
    {
        ...
        [TestMethod]
        public void Trigger_CheckIdAttribute_CheckCategory() => Generic.CheckCategory(check, Category.Trigger);

        [TestMethod]
        public void Trigger_CheckIdAttribute_CheckId() => Generic.CheckId(check, CheckId.CheckIdAttribute);
    }
}