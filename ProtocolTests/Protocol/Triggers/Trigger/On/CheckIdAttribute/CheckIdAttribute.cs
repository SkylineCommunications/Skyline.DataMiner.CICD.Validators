namespace SLDisValidatorUnitTests.Protocol.Triggers.Trigger.On.CheckIdAttribute
{
    ...
    using SLDisValidator2.Tests.Protocol.Triggers.Trigger.On.CheckIdAttribute;
