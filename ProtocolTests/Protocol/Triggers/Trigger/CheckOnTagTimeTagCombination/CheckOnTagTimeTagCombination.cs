namespace SLDisValidatorUnitTests.Protocol.Triggers.Trigger.CheckOnTagTimeTagCombination
{
    ...
    using SLDisValidator2.Tests.Protocol.Triggers.Trigger.CheckOnTagTimeTagCombination;
