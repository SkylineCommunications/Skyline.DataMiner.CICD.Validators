namespace SLDisValidatorUnitTests.Protocol.Triggers.Trigger.Content.Id.CheckIdTag
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Triggers.Trigger.Content.Id.CheckIdTag;
