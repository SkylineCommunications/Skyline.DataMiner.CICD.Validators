namespace SLDisValidatorUnitTests.Protocol.Triggers.Trigger.Condition.CheckConditionTag
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Triggers.Trigger.Condition.CheckConditionTag;
