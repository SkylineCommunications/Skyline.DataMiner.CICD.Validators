namespace SLDisValidatorUnitTests.Protocol.Timers.Timer.Content.Group.CheckGroupTag
{
    ...
    using SLDisValidator2.Tests.Protocol.Timers.Timer.Content.Group.CheckGroupTag;
