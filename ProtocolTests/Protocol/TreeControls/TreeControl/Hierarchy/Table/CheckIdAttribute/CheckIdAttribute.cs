namespace SLDisValidatorUnitTests.Protocol.TreeControls.TreeControl.Hierarchy.Table.CheckIdAttribute
{
    ...
    using SLDisValidator2.Tests.Protocol.TreeControls.TreeControl.Hierarchy.Table.CheckIdAttribute;
