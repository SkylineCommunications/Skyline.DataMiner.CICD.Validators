namespace SLDisValidatorUnitTests.Protocol.Actions.Action.Condition.CheckConditionTag
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Actions.Action.Condition.CheckConditionTag;
