namespace SLDisValidatorUnitTests.Protocol.Pairs.Pair.Content.Command.CheckCommandTag
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Pairs.Pair.Content.Command.CheckCommandTag;
