namespace SLDisValidatorUnitTests.Protocol.Pairs.Pair.Content.Response.CheckResponseTag
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Pairs.Pair.Content.Response.CheckResponseTag;
