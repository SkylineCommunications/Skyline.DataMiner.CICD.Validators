namespace ProtocolTests.Protocol.Pairs.Pair.Condition.CheckConditionTag
{
    using System;
    ...
    using Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.Pairs.Pair.Condition.CheckConditionTag;
    ...
    public class Validate
    {
        ...
        [TestMethod]
        public void Pair_CheckConditionTag_Valid()
        {
        ...
        [TestMethod]
        public void Pair_CheckConditionTag_InvalidCondition()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
        ...
        [TestMethod]
        public void Pair_CheckConditionTag_NonExistingId()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Pair_CheckConditionTag_ConditionCanBeSimplified()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
    ...
    public class Attribute
    {
        ...
        [TestMethod]
        public void Pair_CheckConditionTag_CheckCategory() => Generic.CheckCategory(check, Category.Pair);

        [TestMethod]
        public void Pair_CheckConditionTag_CheckId() => Generic.CheckId(check, CheckId.CheckConditionTag);
    }
}