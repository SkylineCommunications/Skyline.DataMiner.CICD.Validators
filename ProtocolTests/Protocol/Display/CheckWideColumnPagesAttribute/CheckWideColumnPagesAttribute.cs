namespace SLDisValidatorUnitTests.Protocol.Display.CheckWideColumnPagesAttribute
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Display.CheckWideColumnPagesAttribute;
