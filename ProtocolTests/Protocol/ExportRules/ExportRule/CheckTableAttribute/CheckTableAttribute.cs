namespace SLDisValidatorUnitTests.Protocol.ExportRules.ExportRule.CheckTableAttribute
{
    ...
    using SLDisValidator2.Tests.Protocol.ExportRules.ExportRule.CheckTableAttribute;
