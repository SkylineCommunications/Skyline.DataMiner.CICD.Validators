namespace SLDisValidatorUnitTests.Protocol.Groups.Group.Content.Pair.CheckPairTag
{
    ...
    using SLDisValidator2.Tests.Protocol.Groups.Group.Content.Pair.CheckPairTag;
