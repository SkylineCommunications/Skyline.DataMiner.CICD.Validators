namespace SLDisValidatorUnitTests.Protocol.Groups.Group.Content.Trigger.CheckTriggerTag
{
    ...
    using SLDisValidator2.Tests.Protocol.Groups.Group.Content.Trigger.CheckTriggerTag;
