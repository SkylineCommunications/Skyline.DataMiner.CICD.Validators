namespace SLDisValidatorUnitTests.Protocol.Groups.Group.CheckIdAttribute
{
    using System;
    ...
    using SLDisValidator2.Tests.Protocol.Groups.Group.CheckIdAttribute;
    ...
    public class Validate
    {
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_Valid()
        {
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_ValidHttp()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Valid,
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_ValidVirtual()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Valid,
                FileName = "ValidVirtual",
                ExpectedResults = new List<IValidationResult>()
            };
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_DuplicatedId()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_EmptyAttribute()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_InvalidValue()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_MissingAttribute()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_UntrimmedAttribute()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
    ...
    public class Attribute
    {
        ...
        [TestMethod]
        public void Group_CheckIdAttribute_CheckCategory() => Generic.CheckCategory(check, Category.Group);

        [TestMethod]
        public void Group_CheckIdAttribute_CheckId() => Generic.CheckId(check, CheckId.CheckIdAttribute);
    }
}