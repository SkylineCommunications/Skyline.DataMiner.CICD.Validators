namespace ProtocolTests.Protocol.Groups.Group.Name.CheckNameTag
{
    ...
    using Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.Groups.Group.Name.CheckNameTag;
