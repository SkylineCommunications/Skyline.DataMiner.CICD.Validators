namespace ProtocolTests.Protocol.Responses.Response.CheckIdAttribute
{
    using System;
    ...
    using Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.Responses.Response.CheckIdAttribute;
    ...
    public class Validate
    {
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_Valid()
        {
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_DuplicatedId()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_EmptyAttribute()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_InvalidValue()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_MissingAttribute()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_UntrimmedAttribute()
        {
            Generic.ValidateData data = new Generic.ValidateData
            {
                TestType = Generic.TestType.Invalid,
    ...
    public class ErrorMessages
    {
        ...
        public void Response_CheckIdAttribute_DuplicatedId()
        {
            ...
            var expected = new ValidationResult()
            {
                ...
                GroupDescription = "",
                Description = "More than one Response with same ID '2'. Response Names '3'.",
                HowToFix = "",
                ExampleCode = "",
                Details = "The id attribute is used internally as the identifier for each response." + Environment.NewLine + "It is therefore mandatory and needs to follow a number of rules:" + Environment.NewLine + "- Each response should have a unique id." + Environment.NewLine + "- Should be an unsigned integer." + Environment.NewLine + "- Only plain numbers are allowed (no leading signs, no leading zeros, no scientific notation, etc).",
                HasCodeFix = false,
            };
        ...
        public void Response_CheckIdAttribute_EmptyAttribute()
        {
            ...
            var expected = new ValidationResult()
            {
                ...
                FixImpact = FixImpact.Breaking,
                GroupDescription = "",
                Description = "Empty attribute 'Response@id'.",
                HowToFix = "",
                ExampleCode = "",
                Details = "The id attribute is used internally as the identifier for each response." + Environment.NewLine + "It is therefore mandatory and needs to follow a number of rules:" + Environment.NewLine + "- Each response should have a unique id." + Environment.NewLine + "- Should be an unsigned integer." + Environment.NewLine + "- Only plain numbers are allowed (no leading signs, no leading zeros, no scientific notation, etc).",
                HasCodeFix = false,
        ...
        public void Response_CheckIdAttribute_InvalidValue()
        {
            ...
            var expected = new ValidationResult()
            {
                ...
                FixImpact = FixImpact.Breaking,
                GroupDescription = "",
                Description = "Invalid value 'AAA' in attribute 'Response@id'. Response name 'MyName'.",
                HowToFix = "",
                ExampleCode = "",
                Details = "The id attribute is used internally as the identifier for each response." + Environment.NewLine + "It is therefore mandatory and needs to follow a number of rules:" + Environment.NewLine + "- Each response should have a unique id." + Environment.NewLine + "- Should be an unsigned integer." + Environment.NewLine + "- Only plain numbers are allowed (no leading signs, no leading zeros, no scientific notation, etc).",
                HasCodeFix = false,
        ...
        public void Response_CheckIdAttribute_MissingAttribute()
        {
            ...
            var expected = new ValidationResult()
            {
                ...
                FixImpact = FixImpact.Breaking,
                GroupDescription = "",
                Description = "Missing attribute 'Response@id'.",
                HowToFix = "",
                ExampleCode = "",
                Details = "The id attribute is used internally as the identifier for each response." + Environment.NewLine + "It is therefore mandatory and needs to follow a number of rules:" + Environment.NewLine + "- Each response should have a unique id." + Environment.NewLine + "- Should be an unsigned integer." + Environment.NewLine + "- Only plain numbers are allowed (no leading signs, no leading zeros, no scientific notation, etc).",
                HasCodeFix = false,
        ...
        public void Response_CheckIdAttribute_UntrimmedAttribute()
        {
            ...
            var expected = new ValidationResult()
            {
                ...
                GroupDescription = "",
                Description = "Untrimmed attribute 'Response@id'. Current value '2'.",
                HowToFix = "",
                ExampleCode = "",
                Details = "The id attribute is used internally as the identifier for each response." + Environment.NewLine + "It is therefore mandatory and needs to follow a number of rules:" + Environment.NewLine + "- Each response should have a unique id." + Environment.NewLine + "- Should be an unsigned integer." + Environment.NewLine + "- Only plain numbers are allowed (no leading signs, no leading zeros, no scientific notation, etc).",
                HasCodeFix = true,
    ...
    public class Attribute
    {
        ...
        [TestMethod]
        public void Response_CheckIdAttribute_CheckCategory() => Generic.CheckCategory(check, Category.Response);

        [TestMethod]
        public void Response_CheckIdAttribute_CheckId() => Generic.CheckId(check, CheckId.CheckIdAttribute);
    }
}