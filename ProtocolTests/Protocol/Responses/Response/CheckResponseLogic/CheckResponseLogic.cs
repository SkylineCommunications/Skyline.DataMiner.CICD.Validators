namespace SLDisValidatorUnitTests.Protocol.Responses.Response.CheckResponseLogic
{
    ...
    using SLDisValidator2.Tests.Protocol.Responses.Response.CheckResponseLogic;
