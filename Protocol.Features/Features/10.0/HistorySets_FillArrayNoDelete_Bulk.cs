namespace Skyline.DataMiner.CICD.Validators.Protocol.Features.Features
{
    ...
    internal class HistorySetsFillArrayNoDeleteBulk : IFeatureCheck
    {
        ...
        public string Description => "History Sets - FillArrayNoDelete - Bulk.";
        ...
        private sealed class QActionAnalyzer : CSharpAnalyzerBase
        {
            ...
            {
                if (!callingMethod.IsQActionTable(semanticModel) || !String.Equals(callingMethod.Name, "FillArrayNoDelete"))
                {
                    return;
                }
            ...
            {
                if (!callingMethod.IsNotifyProtocol(semanticModel, solution, 194))
                {
                    return false;
                }
                ...
                {
                    // Unable to parse the value inside the Array.
                    return false;
                }
