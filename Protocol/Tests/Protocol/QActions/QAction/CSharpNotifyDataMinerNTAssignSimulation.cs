namespace SLDisValidator2.Tests.Protocol.QActions.QAction.CSharpNotifyDataMinerNTAssignSimulation
{
    ...
    internal class QActionAnalyzer : CSharpAnalyzerBase
    {
        ...
        {
            // protocol.NotifyDataMiner(76, [Array], null)

            if (!callingMethod.IsNotifyDataMiner(semanticModel, solution, 76))
            {
                return;
            }
