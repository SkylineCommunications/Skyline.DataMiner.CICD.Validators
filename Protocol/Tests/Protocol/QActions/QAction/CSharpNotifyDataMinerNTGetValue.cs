namespace Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.QActions.QAction.CSharpNotifyDataMinerNTGetValue
{
    ...
    internal class QActionAnalyzer : QActionAnalyzerBase
    {
        ...
        {
            // protocol.NotifyDataMiner(69, [Array], null)

            if (!callingMethod.IsNotifyDataMiner(semanticModel, solution, 69))
            {
                return;
            }
