namespace Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.QActions.QAction.CSharpSLProtocolFillArray
{
    ...
    internal class QActionAnalyzer : QActionAnalyzerBase
    {
        ...
        public override void CheckCallingMethod(CallingMethodClass callingMethod)
        {
            ...
            CheckWhenColumns(callingMethod, tableParam);
            CheckWhenRows(callingMethod, tableParam);
        }

        private void CheckWhenRows(CallingMethodClass callingMethod, IParamsParam tableParam)
        {
        ...
        private void CheckWhenColumns(CallingMethodClass callingMethod, IParamsParam tableParam)
        {
