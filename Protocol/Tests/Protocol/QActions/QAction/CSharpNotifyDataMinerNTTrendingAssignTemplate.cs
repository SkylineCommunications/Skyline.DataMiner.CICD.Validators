namespace SLDisValidator2.Tests.Protocol.QActions.QAction.CSharpNotifyDataMinerNTTrendingAssignTemplate
{
    ...
    internal class QActionAnalyzer : CSharpAnalyzerBase
    {
        ...
        {
            // protocol.NotifyDataMiner(14, [Array], null)

            if (!callingMethod.IsNotifyDataMiner(semanticModel, solution, 14))
            {
                return;
            }
