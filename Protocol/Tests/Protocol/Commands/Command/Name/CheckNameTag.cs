namespace Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.Commands.Command.Name.CheckNameTag
{
    using System;
    ...
    internal class CheckNameTag : IValidate/*, ICodeFix, ICompare*/
    {
        public List<IValidationResult> Validate(ValidatorContext context)
        {
            ...
            var commands = context.EachCommandWithValidId().ToList();
