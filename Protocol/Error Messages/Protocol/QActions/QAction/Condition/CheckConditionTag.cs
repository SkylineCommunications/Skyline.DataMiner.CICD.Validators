    ...
    internal static class Error
    {
        ...
        public static IValidationResult ConditionCanBeSimplified(IValidate test, IReadable referenceNode, IReadable positionNode, string conditionString, string qactionId)
        {
            return new ValidationResult
            {
                ...
                HowToFix = "",
                ExampleCode = "",
                Details = "The 'QAction/Condition' can be simplified. Some examples of when the condition can be simplified:" + Environment.NewLine + "  - The condition contains redundant parentheses." + Environment.NewLine + "  - The condition does not contain a variable and therefore can either be dropped completely (or a variable must be included).",
                HasCodeFix = false,
