namespace SLDisValidator2.Tests.Protocol.QActions.QAction.CSharpSLProtocolFillArrayNoDelete
{
    using System;
    ...
    internal static class Error
    {
        internal static IValidationResult NonExistingParam(IValidate test, IReadable referenceNode, IReadable positionNode, string tablePid, string qactionId)
        {
            ...
            {
                Test = test,
                CheckId = CheckId.CSharpSLProtocolFillArrayNoDelete,
    ...
    {
        public const uint CSharpSLProtocolFillArrayNoDelete = 10;
    }
}