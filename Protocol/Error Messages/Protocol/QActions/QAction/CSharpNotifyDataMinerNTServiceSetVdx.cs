namespace Skyline.DataMiner.CICD.Validators.Protocol.Tests.Protocol.QActions.QAction.CSharpNotifyDataMinerNTServiceSetVdx
{
    using System;
    ...
    internal static class Error
    {
        public static IValidationResult DeltIncompatible(IValidate test, IReadable referenceNode, IReadable positionNode, string qactionId)
        {
            ...
            {
                Test = test,
                CheckId = CheckId.CSharpNotifyDataMinerNTServiceSetVdx,
                ...
                GroupDescription = "",
                Description = String.Format("Invocation of method '{0}.{1}' is not compatible with '{2}'. QAction ID '{3}'.", "SLProtocol", "NotifyDataMiner(Queued)(232/*NT_SERVICE_SET_VDX*/, ...)", "DELT", qactionId),
                HowToFix = "",
    ...
    public static class CheckId
    {
        ...
        /// </summary>
        public const uint CSharpNotifyDataMinerNTServiceSetVdx = 28;
    }
}