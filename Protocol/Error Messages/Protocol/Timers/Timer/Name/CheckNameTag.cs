namespace SLDisValidator2.Tests.Protocol.Timers.Timer.Name.CheckNameTag
{
    using System;
    ...
    public static class Error
    {
        public static IValidationResult DuplicatedValue(IValidate test, IReadable referenceNode, IReadable positionNode, string duplicateName, string timerIds)
        {
            return new ValidationResult
            {
                ...
                GroupDescription = "",
                Description = String.Format("Duplicated {0} {1} '{2}'. {0} IDs '{3}'.", "Timer", "Name", duplicateName, timerIds),
                HowToFix = "",
                ExampleCode = "",
                Details = "",
                HasCodeFix = false,
